...
<script lang="ts">
import BookingFormModal from '@/modules/booking/components/booking-form-modal.vue';
import { BookingPermissions } from '@/modules/booking/booking-permissions';
import { mapGetters } from 'vuex';

import Vue from 'vue';
export default Vue.extend({
  name: 'app-booking-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    'app-booking-form-modal': BookingFormModal,
  },
