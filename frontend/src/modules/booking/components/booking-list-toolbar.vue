...
export default Vue.extend({
  name: 'app-booking-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'booking/list/hasRows',
      loading: 'booking/list/loading',
      exportLoading: 'booking/list/exportLoading',
      selectedRows: 'booking/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'booking/list/doExport',
      doRemoveAllSelected:
        'booking/list/doRemoveAllSelected',
      doDisableAllSelected:
        'booking/list/doDisableAllSelected',
      doEnableAllSelected:
        'booking/list/doEnableAllSelected',
      doDestroyAll: 'booking/destroy/doDestroyAll',
    }),
