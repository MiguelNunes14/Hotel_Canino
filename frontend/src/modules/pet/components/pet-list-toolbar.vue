...
export default Vue.extend({
  name: 'app-pet-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'pet/list/hasRows',
      loading: 'pet/list/loading',
      exportLoading: 'pet/list/exportLoading',
      selectedRows: 'pet/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'pet/list/doExport',
      doRemoveAllSelected:
        'pet/list/doRemoveAllSelected',
      doDisableAllSelected:
        'pet/list/doDisableAllSelected',
      doEnableAllSelected:
        'pet/list/doEnableAllSelected',
      doDestroyAll: 'pet/destroy/doDestroyAll',
    }),
